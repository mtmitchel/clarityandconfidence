      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-8">
        <div className="space-y-6">
          <div className="text-center">
            <h2 className="text-2xl font-semibold text-blue-900 mb-3">Stress level self-assessment</h2>
          ...
          <div className="space-y-4">
            ...
            {Object.keys(assessmentResponses).length === stressQuestions.length && (
              <div className="bg-white rounded-lg p-6 border-l-4 border-blue-600">
                <h3 className="font-semibold text-neutral-800 mb-2">Your Assessment Results</h3>
